<!-- source: https://json-render.dev/docs/api/devtools -->
# @json-render/devtools

Framework-agnostic core for the json-render devtools — providing vanilla TS panel UI, event store, DOM picker, and stream tap utilities. Every framework-specific adapter package depends on this.
